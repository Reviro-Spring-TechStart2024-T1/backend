    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('owner', models.ForeignKey(limit_choices_to={'role': 'partner'}, on_delete=django.db.models.deletion.CASCADE, related_name='establishments', to=settings.AUTH_USER_MODEL)),
            ],
            options={
